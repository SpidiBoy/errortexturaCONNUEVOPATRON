...
import Entidades.*;
import Entidades.GameStateListener;
...
public class JuegoBuilder {
    ...
    // ==================== PASOS DE CONSTRUCCIÓN ====================
        public JuegoBuilder cargarRecursos() {
        System.out.println("[BUILDER] Paso 1/6: Cargando recursos...");
        
        // ✅ Crear ResourceManager (NO Singleton)
        CargadorImagenes imageLoader = new CargadorImagenes();
        this.resourceManager = new ResourceManager(imageLoader);
        
        // Cargar recursos globales
        resourceManager.loadGlobalResources();
        
        // Cargar nivel inicial
        resourceManager.loadLevel(1);
        
        System.out.println("[BUILDER] ✓ Recursos cargados");
        return this;
    }
    ...
    public JuegoBuilder inicializarHandler() {
      ...
      public JuegoBuilder inicializarEventos() {
        ...
        eventManager.registerPlayerListener(new GameStateListener(estadoJuego));
        eventManager.registerPlayerListener(new PowerUpListener());
    ...
    public JuegoBuilder crearJugador() {
        ...
        // ✅ Inyectar EventManager al Player
        this.jugador = new Player(100, 100, 2, handler, eventManager );
    ...
    private void validarComponentes() {
        if (resourceManager == null || handler == null || gestorEstados == null || 
