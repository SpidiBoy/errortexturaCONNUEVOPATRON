...
public class Player extends JuegoObjetos {
 private static final float WIDTH = 16;
    ...
    private final PlayerLadderComponent ladder;
    private final PlayerCollisionComponent collision;
     ...
     */
    public Player(float x, float y, int scale, Handler handler, EventManager eventManager) {
        ...
        this.physics = new PlayerPhysicsComponent(this, handler);
        this.ladder = new PlayerLadderComponent(this, handler);
        this.collision = new PlayerCollisionComponent(this, handler, ladder, physics);
        ...
        this.poderMartillo = new PoderMartillo(this, handler,resources);
    ...
    public Player(float x, float y, int scale, Handler handler) {
        this(x, y, scale, handler, EventManager.getInstance());
    }
    
    // ==================== INICIALIZACIÓN ====================
    
    private void inicializarAnimaciones() {
        spriteMuerte = resources.getPlayerRepository().getDeathAnimation();
        spriteMartillo = resources.getPlayerRepository().getHammerAnimation();
        spriteS = resources.getPlayerRepository().getWalkingAnimation();
    ...
    public void recibirDanio(JuegoObjetos enemigo) {
        ...
        PlayerDamagedEvent event = new PlayerDamagedEvent(this, enemigo);
        ...
        PlayerDeathEvent deathEvent = new PlayerDeathEvent(this, enemigo);
    ...
    public void colectarItem(String itemType, int puntos) {
        ...
        PlayerCollectItemEvent event = new PlayerCollectItemEvent(
    ...
    public void activarMartillo() {
        if (poderMartillo != null) {
            ...
            // ✅ EMITIR EVENTO
            PlayerPowerUpEvent event = new PlayerPowerUpEvent(this, "MARTILLO");
