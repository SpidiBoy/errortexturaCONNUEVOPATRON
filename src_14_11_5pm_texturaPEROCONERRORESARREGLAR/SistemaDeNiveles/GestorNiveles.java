...
public class GestorNiveles {
    ...
    private void cargarSpritesVictoria() {
        try {
            spriteCorazon = resources.getItemRepository().getHeartSprite();
            spriteCorazonRoto = resources.getItemRepository().getBrokenHeartSprite();
            spritesDKAgarra = resources.getNPCRepository().getDKGrabAnimation();
